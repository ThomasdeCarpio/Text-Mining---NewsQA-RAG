...
from newsqa_rag.crawler.models import DiscoveredArticle, ParsedArticle, StorageLocations
from newsqa_rag.crawler.utils import (
    append_jsonl,
    build_output_paths,
    canonicalize_url,
    ...
    def __init__(self, token: str) -> None:
        try:
            ...
            raise RuntimeError(
                ...
                "Install requirements-crawler.txt."
            ) from exc
