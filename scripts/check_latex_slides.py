...
def main() -> None:
    ...
    expected = [
        ...
        ["Giải thích thước đo dẫn nguồn", "Validity", "Citation F1"],
        ...
        ["P0 đối chứng", number("PzeroAC"), number("PzeroFaith"), number("PzeroEM"),
         number("PzeroFone"), number("PzeroCitFone"), number("PzeroCitVal")],
        ["P0", "P1", "P2", "P3", "Giả thuyết", "Chỉ thị khác biệt",
         number("ScreenPtwoAC"), number("ScreenPtwoFaith"),
         number("ScreenPtwoCitFone"), number("ScreenPtwoCitVal"), number("NJudgeScreening")],
        ["Context depth", number("LostAtDepthThree"), number("PoneHitOne"), number("DepthPtwoThreeAC")],
        [number(k) for k in ("PtwodThreeAC", "PtwodFiveAC")],
        ...
        [number(k) for k in ("HoAC", "HoFaith", "HoCitFone", "HoCitVal")],
        ["Không có gold", number("HoNMiss"), number("HoHitAC"), number("HoMissAC")],
        ["one-shot", "P2-1S", "Northbridge", "Riverside"],
        ["P2-1S", "0,8015", "0,6267", "+0,0664"],
        ["Mô hình generator", "3.5 Flash-Lite", "3.6 Flash", "0,8164"],
        ["3.5 Flash-Lite", "3.6 Flash", "3,50", "Đánh đổi"],
