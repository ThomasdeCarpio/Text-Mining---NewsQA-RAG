...
Usage:
    python -m newsqa_rag.crawler.crawl_articles --max-articles 50
    python -m newsqa_rag.crawler.crawl_articles --sources reuters,bbc --categories World,Business
"""
...
from newsqa_rag.crawler.fetcher import FetchConfig, PlaywrightFetcher
from newsqa_rag.crawler.filters import text_contains_vietnam_terms
from newsqa_rag.crawler.models import DiscoveredArticle, ParsedArticle
from newsqa_rag.crawler.parser import build_normalized_html, parse_rendered_article
from newsqa_rag.crawler.sources import (
    discover_source_articles,
    get_source_configs,
    parse_categories,
    parse_source_keys,
)
from newsqa_rag.crawler.storage import (
    ArticleStorage,
    CompositeStorage,
    FilesystemStorage,
