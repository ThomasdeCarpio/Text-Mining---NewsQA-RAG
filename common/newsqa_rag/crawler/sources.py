...
from newsqa_rag.crawler.filters import (
    deduplicate_articles,
    is_allowed_domain,
    is_probable_article_url,
    should_skip_article,
)
from newsqa_rag.crawler.models import DiscoveredArticle, FeedConfig, IndexPageConfig, SourceConfig
from newsqa_rag.crawler.utils import canonicalize_url, parse_datetime, strip_html
...
def _discover_feed_articles(
    ...
    try:
        ...
        raise RuntimeError("feedparser is required for RSS discovery. Install requirements-crawler.txt.") from exc
