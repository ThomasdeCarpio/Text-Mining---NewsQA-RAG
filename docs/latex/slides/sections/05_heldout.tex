...
\begin{frame}[shrink=20]{Phát hiện quan trọng nhất: prompt \emph{không} bị overfit}
  ...
  \vspace{0.5em}
  \begin{itemize}
    \item Trên các câu truy xuất làm đúng việc, held-out (\NumHoHitAC) \textbf{cao
          hơn} dev (\NumPtwodFiveHitAC) --- prompt tổng quát hóa được.
  ...
  \takeaway{Toàn bộ khoảng cách dev $\rightarrow$ held-out là câu chuyện của truy xuất, không phải của prompt.}
\end{frame}
