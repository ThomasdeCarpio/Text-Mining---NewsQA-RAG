...
\begin{frame}[shrink=20]{Chưa được phép kết luận gì}
  ...
  \textbf{Phase 2}
  \begin{itemize}\small
    \item Answer Correctness \NumHoAC{} là \textbf{cận dưới}: audit 30 câu điểm
          thấp nhất thấy \textbf{23/30} thực ra đúng về ngữ nghĩa, và giám khảo
          bất đồng với người duyệt ở \textbf{18/30} câu.
