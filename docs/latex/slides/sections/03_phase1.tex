...
\begin{frame}{Thiết kế: giải đấu phân tầng}{23 cấu hình thay vì 72 tổ hợp}
  \small
...
\begin{frame}{Vòng 1 --- Sparse áp đảo dense}
  \small
...
\begin{frame}{Vòng 2 và 3 --- Reranker cần, chunk size thì không}
  \small
...
\begin{frame}{Ablation bổ sung --- Contextual chunking}{Nếu không phải cắt to hay nhỏ, thì viết lại nội dung chunk?}
  \small
  Thêm \NumCtxChars{} ký tự ngữ cảnh bài báo mẹ vào đầu mỗi chunk
  (\NumCtxContextualised{}/\NumCorpusChunks{} chunk được thêm).
  ...
  \takeaway{Hai hiệu ứng đều có ý nghĩa thống kê, đều dưới ngưỡng \NumNoiseFloor{} --- không đổi quyết định.}
\end{frame}

\begin{frame}{Cấu hình khóa}
  \small
  \begin{center}
