...
\paragraph{Kết quả baseline và phân tích lỗi.}
...
\textbf{Hiện tượng Exact Match bằng 0.} Ở baseline P0-D5, Exact Match đạt $0{,}0000$ dù AC đạt $0{,}6308$ và Faithfulness đạt $0{,}9761$. Nguyên nhân là dữ liệu NewsQA dùng đáp án chuẩn dạng thực thể trích xuất ngắn (extractive span, như ``26'' hay ``Scotland''), trong khi prompt P0 sinh câu hội thoại hoàn chỉnh (như ``Cases were reported in 26 states [5].''), khiến phép so khớp chuỗi tuyệt đối bằng 0. Đây là lý do chính thúc đẩy việc thiết kế prompt P2 (ràng buộc trả lời ngắn đúng loại thực thể) và one-shot P2-1S. Trong mẫu 30 câu có AC dưới 0,5, có 24 câu vẫn tìm được đoạn chuẩn trong top 5; lỗi chủ yếu do trả lời dài, sai loại thông tin hoặc chọn nhầm chi tiết. Điểm thấp không luôn đồng nghĩa sai ngữ nghĩa; mẫu này không đại diện cho tỷ lệ lỗi toàn tập.
...
\paragraph{Kết quả finalist và lựa chọn cấu hình khóa.}
\begin{table}[H]\setstretch{1.05}
  \centering
