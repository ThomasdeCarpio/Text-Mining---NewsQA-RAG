...
Trên các câu mà truy xuất làm đúng việc, held-out đạt \NumHoHitAC{} --- cao hơn
chính development (\NumPtwodFiveHitAC{}). Tỉ lệ truy xuất trượt thì tăng gần ba
...
\keypoint{\textbf{Toàn bộ khoảng cách development $\rightarrow$ held-out là câu
chuyện của truy xuất, không phải của prompt.} Prompt \NumWinnerPrompt{} tổng
quát hóa được sang dữ liệu chưa từng thấy; cái không tổng quát hóa được là độ
dễ của việc tìm đoạn.}
