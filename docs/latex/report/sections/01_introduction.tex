...
\item Prompt zero-shot và số đoạn ngữ cảnh ảnh hưởng thế nào đến chất lượng câu trả lời?
...
Các sản phẩm kỹ thuật gồm dữ liệu có nhãn bằng chứng và lịch sử rà soát, các mô-đun truy xuất, xếp hạng lại và sinh câu trả lời, cùng API và giao diện hiển thị nguồn. Kết quả truy xuất được lưu để so sánh các prompt trong cùng điều kiện. Cấu hình, dấu định danh và trạng thái từng câu hỏi giúp kiểm tra và tái lập các lần chạy đánh giá.
