...
Lời nhắc zero-shot không kèm ví dụ; one-shot có một ví dụ minh họa. Chỉ dấu \texttt{[n]} trong câu trả lời trỏ tới đoạn ngữ cảnh thứ $n$, khác với trích dẫn học thuật trong báo cáo.
